      ...
      <div className="w-full max-w-md relative z-10 animate-reveal">
        <div className="mb-10 text-center">
          ...
          <div className="mt-4 flex items-center justify-center gap-2">
            ...
            <span className="font-mono text-xs uppercase tracking-widest text-muted-foreground">Directory Access</span>
          </div>
        </div>
        ...
        <div className="bg-secondary border border-border p-8">
          ...
          <p className="font-mono text-sm text-muted-foreground mb-8 border-b border-border/50 pb-4">Authenticate to access the founder network.</p>
          ...
          <form onSubmit={handleSignIn} className="space-y-6">
            ...
            <div className="space-y-2">
              <label className="block font-mono text-xs uppercase tracking-wider text-foreground font-bold">.EDU Email</label>
          ...
          <div className="mt-8 text-center border-t border-border/50 pt-6">
            <span className="font-mono text-xs text-muted-foreground uppercase tracking-widest">
              No active session? <Link href="/sign-up" className="text-primary font-bold hover:underline">Create Account</Link>
            </span>
          </div>
        </div>
      </div>
